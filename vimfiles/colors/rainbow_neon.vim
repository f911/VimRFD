...
" Messages
hi ErrorMsg     gui=NONE guifg=#ffa0ff guibg=NONE
hi WarningMsg   gui=NONE guifg=#ffa0ff guibg=NONE
hi ModeMsg      gui=NONE guifg=#a0d0ff guibg=NONE
hi MoreMsg      gui=NONE guifg=#70ffc0 guibg=#8040ff
hi Question     gui=NONE guifg=#e8e800 guibg=NONE
...
hi NonText      gui=NONE guifg=#d84070 guibg=#383838
hi SpecialKey   gui=NONE guifg=#8888ff guibg=NONE
hi Title        gui=NONE guifg=fg      guibg=NONE
...
hi Error        gui=NONE guifg=#ffffff guibg=#8000ff
...
hi Todo         gui=NONE,UNDERLINE guifg=#ff80d0 guibg=NONE
